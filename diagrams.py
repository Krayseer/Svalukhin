...
class Report:
    ...
    def generate_pdf(self):
        path = r'C:\Users\evgen\OneDrive\Рабочий стол\Python\Проекты\Python implementations\2.1\pdf_template.html'
        path_second = r'C:\Users\evgen\OneDrive\Рабочий стол\Python\Проекты' \
                      r'\Python implementations\2.1\pdf_template_second.html'
        path_third = r'C:\Users\evgen\OneDrive\Рабочий стол\Python\Проекты' \
                     r'\Python implementations\2.1\pdf_template_third.html'
        excel_path = r'C:\Users\evgen\OneDrive\Рабочий стол\Python\Проекты\Python implementations\2.1\report.xlsx'
